...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/d2files/OP-Files-Store-Bot)</br
...
#### Deploy in your VPS
````bash
git clone https://github.com/d2files/OP-Files-Store-Bot
cd File-Sharing-Bot
